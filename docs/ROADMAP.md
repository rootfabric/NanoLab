...
**Исходная стадия: документальный фундамент. NL0 ещё не закрыт.** Статусы хранятся в [state.json](../project/state.json), зависимости работ — в [plan.json](../project/plan.json). Сроки и стоимость устанавливаются по измерениям, а не по обещанию ускорения от ИИ.
