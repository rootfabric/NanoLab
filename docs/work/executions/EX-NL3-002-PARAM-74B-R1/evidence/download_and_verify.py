"""Digest-gated download of the pinned 74b hinge source files for
EX-NL3-002-PARAM-74B-R1 (G1=B, no durable cache).

Downloads MD_Hinges/74b.top / MD_Hinges/74b.conf / MD_Hinges/pro_CPU.in into a
...
SHA-256 pins for 74b.top/74b.conf have provenance NOT_VERIFIED (null in the
...
FILES = ["MD_Hinges/74b.top", "MD_Hinges/74b.conf", "MD_Hinges/pro_CPU.in"]
DEST = os.path.join(os.environ.get("TEMP", r"C:\Windows\Temp"), "nl3-002-param-74b-src")
