"""Artifact manifests for EX-NL3-002-PARAM-53B-R1 runs: SHA-256 + size of every
...
def wsl_stat(wsl_dir, name):
    ...
    return {"file": name, "role": "input" if name in ("53b.top", "53b.conf", "pro_CPU.in", "input.in")
...
def main() -> int:
    for run in RUNS:
        ...
        p = run["prefix"]
        files = ["53b.top", "53b.conf", "pro_CPU.in", "input.in",
