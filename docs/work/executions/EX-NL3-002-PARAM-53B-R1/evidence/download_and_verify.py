"""Digest-gated download of the pinned 53b hinge source files for
EX-NL3-002-PARAM-53B-R1 (G1=B, no durable cache).

Downloads MD_Hinges/53b.top / MD_Hinges/53b.conf / MD_Hinges/pro_CPU.in into a
...
SHA-256 pins for 53b.top/53b.conf have provenance NOT_VERIFIED (null in the
...
(size 933 + blob_sha1 + sha256 bd6cd418..., mandatory). Any mandatory mismatch
-> FAIL exit 1 (BLOCKED condition per WO-NL3-002-PARAM stop rules).
"""
import json
import os
import sys
...
FILES = ["MD_Hinges/53b.top", "MD_Hinges/53b.conf", "MD_Hinges/pro_CPU.in"]
DEST = os.path.join(os.environ.get("TEMP", r"C:\Windows\Temp"), "nl3-002-param-53b-src")
...
def main() -> int:
    ...
    report = {"schema_version": 1, "kind": "e2_param_source_download_verification",
              ...
              "work_order": "NL3-002-PARAM", "protocol": "docs/research/E2_PROTO_R1.md (frozen, inherited, incl. addendum s.8) + docs/work/WO-NL3-002-PARAM.md",
