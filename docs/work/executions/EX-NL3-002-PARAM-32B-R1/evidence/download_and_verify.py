"""Digest-gated download of the pinned 32b hinge source files for
EX-NL3-002-PARAM-32B-R1 (G1=B, no durable cache).

Downloads MD_Hinges/32b.top / MD_Hinges/32b.conf / MD_Hinges/pro_CPU.in into a
...
SHA-256 pins for 32b.top/32b.conf have provenance NOT_VERIFIED (null in the
...
FILES = ["MD_Hinges/32b.top", "MD_Hinges/32b.conf", "MD_Hinges/pro_CPU.in"]
DEST = os.path.join(os.environ.get("TEMP", r"C:\Windows\Temp"), "nl3-002-param-32b-src")
