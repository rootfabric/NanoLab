"""Build PARAM-32B run inputs (EX-NL3-002-PARAM-32B-R1) from the pinned author pro_CPU.in.
...
subject change topology/conf_file 74b->32b. Every deviation is recorded in
PARAM-32B-S00X_deviations.json. All digest-gated inputs (32b.top, 32b.conf,
...
SRC = os.path.join(os.environ.get("TEMP", r"C:\Windows\Temp"), "nl3-002-param-32b-src")
SRC_FILES = {
    "MD_Hinges/32b.top": "32b.top",
    "MD_Hinges/32b.conf": "32b.conf",
